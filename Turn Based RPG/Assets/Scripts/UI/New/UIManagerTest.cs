...
public class UIManagerTest : MonoBehaviour
{
    ...
    Dictionary<string, CombatScript> characters = new Dictionary<string, CombatScript>();
    ...
    [SerializeField] bool uiControllsEnabled;
    [SerializeField] bool combatControllsEnabled;
    ...
    void Start()
    {
        ...
        foreach (var entity in FindObjectsOfType<EntityScript>())
        {
            entities.Add( entity.gameObject.GetComponent<CombatScript>().entityName, entity.gameObject);
            CombatScript entityCombat = entity.GetComponent<CombatScript>();
    ...
    public void TargetPicked(List<GameObject> targets)
    {
        ...
        {
            currentActionTargets.Add(targetGo.GetComponent<CombatScript>().entityName);
        }
